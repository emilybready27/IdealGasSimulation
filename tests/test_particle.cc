...
TEST_CASE("Handle outside of bound") {
    ...
    Particle particle = Particle(vec2(775, 775), vec2(-1, -1), 10.0);
...
TEST_CASE("Handle collision with other particle") {
    ci::Rectf bounds = ci::Rectf(vec2(100, 100), vec2(775, 775));
    Particle particle1 = Particle(vec2(775, 775), vec2(-1, -1), 10.0);
    Particle particle2 = Particle(vec2(775, 775), vec2(-1, -1), 10.0);
